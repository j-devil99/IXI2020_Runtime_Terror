# Generated by Django 2.0.1 on 2020-02-04 21:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='john@doe.com', max_length=254)),
                ('GPA', models.FloatField(default=8.0, max_length=10.0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cataegories', multiselectfield.db.fields.MultiSelectField(choices=[('Competitions', 'Competitions'), ('Conferences', 'Conferences'), ('Exchange-Programs', 'Exchange-Programs'), ('Fellowships', 'Fellowships'), ('Internships', 'Internships'), ('Scholarships', 'Scholarships'), ('Workshops', 'Workshops')], max_length=89, null=True)),
                ('domain', multiselectfield.db.fields.MultiSelectField(choices=[('Engineering', 'Engineering'), ('Medicine', 'Medicine'), ('Management', 'Management'), ('Humanities', 'Humanities'), ('Science', 'Science')], max_length=50, null=True)),
                ('education', multiselectfield.db.fields.MultiSelectField(choices=[('Post-Doctorate', 'Post-Doctorate'), ('Doctorate', 'Doctorate'), ('Masters', 'Masters'), ('Bachelors', 'Bachelors'), ('School', 'School')], max_length=49, null=True)),
                ('country', models.CharField(max_length=20, null=True)),
            ],
        ),
    ]
