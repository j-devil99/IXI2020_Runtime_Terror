# Generated by Django 2.0.1 on 2020-02-04 17:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GPA', models.FloatField(default=0.0, max_length=10.0)),
                ('dob', models.DateField(null=True)),
                ('state', models.CharField(max_length=20, null=True)),
                ('country', models.CharField(max_length=20, null=True)),
                ('gender', multiselectfield.db.fields.MultiSelectField(choices=[('Male', 'Male'), ('Female', 'Female'), ('Non-Binary', 'Non-Binary')], max_length=22, null=True)),
